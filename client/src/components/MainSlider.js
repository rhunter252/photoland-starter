...
// img
import SneakerImg1 from "../img/sneaker1.png";
import SneakerImg2 from "../img/sneaker2.png";
import SneakerImg3 from "../img/sneaker3.png";
            ...
            <SwiperSlide key={index}>
              <div className="flex flex-col lg:flex-row h-full p-[20px] md:p-[60px]">
                ...
                <div className="flex-1">
                  <img
                    className="xl:absolute xl:-right-16 xl:-bottom-4"
                    src={slide.img}
                    alt=""
                  />
                </div>
